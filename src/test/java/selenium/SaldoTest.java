...
public class SaldoTest {
    ...
    @Test
    public void shouldCalcSaldoAhorroMenor35uf(){ // long ahorro, long sueldo, int uf, long expected) {
        ...
        // selecciona 10%
        WebElement select_calc_web = driver.findElement(By.cssSelector("input[value='saldo']"));
    ...
    @Test
    public void shouldCalcSaldoAhorroMayor35ufDxCMenor35uf(){ // long ahorro, long sueldo, int uf, long expected) {
        System.out.println("Iniciando Pruebas...");
    ...
    @Test
    public void shouldCalcSaldoAhorroMayor35ufDxCMayor35uf(){ // long ahorro, long sueldo, int uf, long expected) {
        System.out.println("Iniciando Pruebas...");
    ...
    @Test
    public void shouldCalcSaldoAhorroMayor150uf(){
        System.out.println("Iniciando Pruebas...");
